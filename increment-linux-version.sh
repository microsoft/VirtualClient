...
current_version=$(yq '.variables.VcVersion' .pipelines/azure-pipelines-linux.yml)
...
git stash
git checkout HEAD~1
previous_version=$(yq '.variables.VcVersion' .pipelines/azure-pipelines-linux.yml)
