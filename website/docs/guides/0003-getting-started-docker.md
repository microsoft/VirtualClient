...
:::info
Since you can't easily access the VC metric files in containers, it is recommended to setup [Telemetry](/docs/guides/telemetry) to get automatic data upload.
:::
