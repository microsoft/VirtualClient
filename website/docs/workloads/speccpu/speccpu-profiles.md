...
:::info
_SPEC CPU 2017 workloads are long running workloads. When running in Peak performance scenarios, some take more than 2 days to complete. Check the 'Profile Runtimes' section below for more details on what
to expect._
:::
...
- **Profile Parameters**  
  ...
  | CompilerVersion       | Optional. The version of the compiler to use.                                                  |                                                     |
