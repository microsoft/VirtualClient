...
| [HPLinpack](https://microsoft.github.io/VirtualClient/docs/workloads/hplinpack) | Linear Equations | linux-x64, linux-arm64| [IBM](https://netlib.org/benchmark/hpl/IBM_LICENSE.TXT)  |
...
| [Latte](https://microsoft.github.io/VirtualClient/docs/workloads/network-suite) | Network Latencies | win-x64, win-arm64 | [MIT](https://github.com/microsoft/latte/blob/main/LICENSE)  |
