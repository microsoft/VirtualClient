namespace VirtualClient.Contracts
{
    ...
    public interface IFileUploadDescriptorFactory
    {
        ...
        /// </param>
        FileUploadDescriptor CreateDescriptor(FileContext fileContext, IDictionary<string, IConvertible> parameters = null, IDictionary<string, IConvertible> manifest = null, bool timestamped = true);
    }
}