...
namespace VirtualClient.Dependencies
{
    ...
    [UnixCompatible]
    [WindowsCompatible]
    public class HammerDBCreateDB : ExecuteCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HammerDBCreateDB"/> class.
        /// </summary>
        /// <param name="dependencies">An enumeration of dependencies that can be used for dependency injection.</param>
        /// <param name="parameters">A series of key value pairs that dictate runtime execution.</param>
        public HammerDBCreateDB(IServiceCollection dependencies, IDictionary<string, IConvertible> parameters)
        ...
        {
            ConfigurationState state = await this.stateManager.GetStateAsync<ConfigurationState>(nameof(HammerDBCreateDB), cancellationToken);
            ...
            if (state == null)
            {
                ...
                await this.stateManager.SaveStateAsync(
                    nameof(HammerDBCreateDB),
                    new Item<ConfigurationState>(nameof(HammerDBCreateDB), new ConfigurationState()),
                    cancellationToken);
            }
        }
