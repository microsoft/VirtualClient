...
namespace VirtualClient.Monitors
{
    ...
    /// 
    /// </summary>
    public class ExampleProfilingMonitor : VirtualClientComponent
    {
        ...
        /// </param>
        public ExampleProfilingMonitor(IServiceCollection dependencies, IDictionary<string, IConvertible> parameters = null)
                    ...
                    if (DateTime.UtcNow >= nextProfilingTime)
                    {
                        ...
                        try
                        {
                            ...
                            while (!cancellationToken.IsCancellationRequested && DateTime.UtcNow < profilingTime)
                            {
                                if (counter % 10 == 0)
                                {
                                    Console.WriteLine($"[{DateTime.Now}] .......................................Profiling Monitor Running...");
                                }
