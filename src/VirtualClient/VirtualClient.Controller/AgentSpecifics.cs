...
namespace VirtualClient.Controller
{
    ...
    public static class AgentSpecifics
    {
        ...
        public static string GetAgentLocalLogsPath(this PlatformSpecifics platformSpecifics, string agentId, string experimentId, string experimentName = null)
        {
        ...
        public static string GetAgentLocalPackagesPath(this PlatformSpecifics platformSpecifics)
        {
        ...
        public static string GetAgentLocalStatePath(this PlatformSpecifics platformSpecifics, string experimentId)
        {
        ...
        public static string GetAgentLocalTempPath(this PlatformSpecifics platformSpecifics, string experimentId)
        {
        ...
        public static string GetRemoteAgentInstallationPath(this PlatformSpecifics targetPlatformSpecifics)
        {
        ...
        /// </summary>
        /// <param name="targetPlatformSpecifics">Provides the platform and CPU architecture for the target/remote system (e.g. Linux, Windows, X64, ARM64).</param>
        public static string GetRemoteAgentLogsPath(this PlatformSpecifics targetPlatformSpecifics)
        {
            string agentDirectory = AgentSpecifics.GetRemoteAgentDirectoryPath(targetPlatformSpecifics.Platform);
            string defaultPath = targetPlatformSpecifics.Combine(agentDirectory, "logs");
        ...
        public static string GetRemoteAgentLogsPath(this PlatformSpecifics targetPlatformSpecifics, string agentId, string experimentId, string experimentName = null)
        {
            string defaultPath = AgentSpecifics.GetRemoteAgentLogsPath(targetPlatformSpecifics);

            if (!string.IsNullOrWhiteSpace(experimentName))
            {
                defaultPath = targetPlatformSpecifics.Combine(defaultPath, agentId.ToLowerInvariant(), experimentName.ToLowerInvariant());
            }
            else
            {
                defaultPath = targetPlatformSpecifics.Combine(defaultPath, agentId.ToLowerInvariant(), experimentId.ToLowerInvariant());
            }
        ...
        /// <returns>A path on the target system to which the remote packages exists or can be installed.</returns>
        public static string GetRemoteAgentPackagesPath(this PlatformSpecifics targetPlatformSpecifics, string packagesFolder = "packages")
        {
            string agentDirectory = AgentSpecifics.GetRemoteAgentDirectoryPath(targetPlatformSpecifics.Platform);
