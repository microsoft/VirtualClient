    ...
    public class MLPerfTrainingExecutorTests
    {
        ...
        public async Task MLPerfTrainingExecutorInitializesWorkloadAsExpected()
        {
            ...
            List<string> expectedCommands = new List<string>
            {
                ...
                "sudo newgrp docker",
                "sudo docker build --pull -t mlperf-training-anyuser-x86_64 .",
                "sudo bash ./config_DGXA100_1x8x56x1.sh",
                "sudo export CUDA_VISIBLE_DEVICES=\"0,1,2,3,4,5,6,7\"",
                "sudo export BATCHSIZE=45",
                "sudo su"
            };
        ...
        private IEnumerable<string> GetExpectedCommands()
        {
            ...
            commands = new List<string>
            {
                ...
                "sudo export BATCHSIZE=45",
                "sudo su",
                "sudo bash CONT=mlperf-training-anyuser-x86_64 DATADIR=/mlperfDataDrive/bert_data/hdf5/training-4320/hdf5_4320_shards_varlength DATADIR_PHASE2=/mlperfDataDrive/bert_data/hdf5/training-4320/hdf5_4320_shards_varlength EVALDIR=/mlperfDataDrive/bert_data/hdf5/eval_varlength CHECKPOINTDIR=/mlperfDataDrive/bert_data/phase1 CHECKPOINTDIR_PHASE1=/mlperfDataDrive/bert_data/phase1 ./run_with_docker.sh"
            };
