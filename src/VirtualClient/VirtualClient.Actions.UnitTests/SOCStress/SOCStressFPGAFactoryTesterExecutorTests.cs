...
namespace VirtualClient.Actions.SOCStress
{
    ...
    public class SOCStressFPGAFactoryTesterExecutorTests
    {
        ...
        [Test]
        [TestCase(false, false, false, false, "fpgafactorytester -duration 300")]
        [TestCase(false, false, false, true, "fpgafactorytester -duration 300 -verbose")]
        [TestCase(false, false, true, false, "fpgafactorytester -duration 300 -virus 0")]
        [TestCase(false, false, true, true, "fpgafactorytester -duration 300 -virus 0 -verbose")]
        [TestCase(false, true, false, false, "fpgafactorytester -duration 300 -dram 0")]
        [TestCase(false, true, false, true, "fpgafactorytester -duration 300 -dram 0 -verbose")]
        [TestCase(false, true, true, false, "fpgafactorytester -duration 300 -dram 0 -virus 0")]
        [TestCase(false, true, true, true, "fpgafactorytester -duration 300 -dram 0 -virus 0 -verbose")]
        [TestCase(true, false, false, false, "fpgafactorytester -duration 300 -pcie 0")]
        [TestCase(true, false, false, true, "fpgafactorytester -duration 300 -pcie 0 -verbose")]
        [TestCase(true, false, true, false, "fpgafactorytester -duration 300 -pcie 0 -virus 0")]
        [TestCase(true, false, true, true, "fpgafactorytester -duration 300 -pcie 0 -virus 0 -verbose")]
        [TestCase(true, true, false, false, "fpgafactorytester -duration 300 -pcie 0 -dram 0")]
        [TestCase(true, true, false, true, "fpgafactorytester -duration 300 -pcie 0 -dram 0 -verbose")]
        [TestCase(true, true, true, false, "fpgafactorytester -duration 300 -pcie 0 -dram 0 -virus 0")]
        [TestCase(true, true, true, true, "fpgafactorytester -duration 300 -pcie 0 -dram 0 -virus 0 -verbose")]
