...
namespace VirtualClient.Actions
{
    ...
    public class DCGMIDiscoveryExecutorTests
    {
        ...
        [Test]
        public async Task TestDCGMIDiscoveryListCommandExecutesExpectedCommandsOnUbuntu()
        {
            ...
            using (TestDCGMIDiscoveryExecutor testDCGMIDiscoveryExecutor = new TestDCGMIDiscoveryExecutor(this.mockFixture.Dependencies, this.mockFixture.Parameters))
            {
                await testDCGMIDiscoveryExecutor.ExecuteAsync(cancellationtoken).ConfigureAwait(false);
            }
        ...
        private class TestDCGMIDiscoveryExecutor : DCGMIDiscoveryExecutor
        {
            public TestDCGMIDiscoveryExecutor(IServiceCollection dependencies, IDictionary<string, IConvertible> parameters)
