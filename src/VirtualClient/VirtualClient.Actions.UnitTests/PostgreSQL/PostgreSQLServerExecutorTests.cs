...
namespace VirtualClient.Actions
{
    ...
    public class PostgreSQLServerExecutorTests
    {
        ...
        public void PostgreSQLServerExecutorThrowsOnFailingToCreateWorkloadState()
        {
            ...
            this.fixture.ApiClient.Setup(client => client.GetStateAsync(nameof(PostgreSQLDatabaseState), It.IsAny<CancellationToken>(), It.IsAny<IAsyncPolicy<HttpResponseMessage>>()))
                .ReturnsAsync(this.fixture.CreateHttpResponse(HttpStatusCode.NotFound));

            using TestPostgreSQLServerExecutor executor = new TestPostgreSQLServerExecutor(this.fixture.Dependencies, this.fixture.Parameters);

            this.fixture.ApiClient.Setup(client => client.CreateStateAsync(nameof(PostgreSQLDatabaseState), It.IsAny<JObject>(), It.IsAny<CancellationToken>(), It.IsAny<IAsyncPolicy<HttpResponseMessage>>()))
                .ReturnsAsync(this.fixture.CreateHttpResponse(HttpStatusCode.NotFound));
        ...
        public void PostgreSQLServerExecutorThrowsOnFailingToUpdateWorkloadState()
        {
            ...
            this.fixture.ApiClient.Setup(client => client.UpdateStateAsync(nameof(PostgreSQLDatabaseState), It.IsAny<JObject>(), It.IsAny<CancellationToken>(), It.IsAny<IAsyncPolicy<HttpResponseMessage>>()))
                .ReturnsAsync(this.fixture.CreateHttpResponse(HttpStatusCode.NotFound));
        ...
        private void SetupDefaultMockBehavior(PlatformID platform = PlatformID.Unix, Architecture architecture = Architecture.X64)
        {
            ...
            var expectedState = new Item<State>(nameof(PostgreSQLDatabaseState), new PostgreSQLDatabaseState(databaseCreated: true));
