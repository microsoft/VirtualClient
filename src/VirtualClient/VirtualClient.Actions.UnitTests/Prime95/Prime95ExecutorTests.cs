...
namespace VirtualClient.Actions
{
    ...
    public class Prime95ExecutorTests
    {
        ...
        public void SetupTest(PlatformID platform)
        {
            ...
            this.exampleResults = File.ReadAllText(this.mockFixture.Combine(!OperatingSystem.IsWindows(), Prime95ExecutorTests.ExamplesDirectory, "prime95_results_example_pass.txt"));
