...
namespace VirtualClient.Actions
{
    ...
    internal class RedisBenchmarkMetricsParserTests
    {
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(RedisBenchmarkMetricsParserTests), "test_examples", @"Redis\RedisBenchmarkResults.txt"));
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(RedisBenchmarkMetricsParserTests), "test_examples", @"Redis\RedisBenchmarkResults_2.txt"));
            var parser = new RedisBenchmarkMetricsParser(results);
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(RedisBenchmarkMetricsParserTests), "test_examples", @"Redis\RedisBenchmarkResults.txt")).Substring(0, 100); // invalid results
            var parser = new RedisBenchmarkMetricsParser(results);
