...
namespace VirtualClient.Actions.NetworkPerformance
{
    ...
    [TestFixture]
    [Category("Unit")]
    public class CPSMetricsParserTests
    {
        ...
        public void CpsParserParsesExpectedMetricsFromValidServerSideResults()
        {
            ...
            string results = CPSMetricsParserTests.GetFileContents("CPS_Example_Results_Server.txt");
        ...
        {
            this.mockFixture.Setup(PlatformID.Win32NT);
            string results = CPSMetricsParserTests.GetFileContents("CPS_Example_Results_Client.txt");
