...
namespace VirtualClient.Dependencies
{
    ...
    {
        private const string SetupCommand = "curl -fsSL https://nvidia.github.io/libnvidia-container/gpgkey | sudo gpg --dearmor -o /usr/share/keyrings/nvidia-container-toolkit-keyring.gpg \\" +
