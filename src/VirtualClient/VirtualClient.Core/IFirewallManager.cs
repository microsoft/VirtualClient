...
namespace VirtualClient
{
    ...
    public interface IFirewallManager
    {
        ...
        Task EnableInboundConnectionAsync(FirewallEntry firewallEntry, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">A token that can be used to cancel the operation.</param>
        Task EnableInboundConnectionsAsync(IEnumerable<FirewallEntry> firewallEntries, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken">A token that can be used to cancel the operation.</param>
        Task EnableInboundAppAsync(FirewallEntry firewallEntry, CancellationToken cancellationToken);
    }
}
