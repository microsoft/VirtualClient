...
namespace VirtualClient
{
    ...
    public static class VirtualClientLoggingExtensions
    {
        ...
        public static Task LogProcessDetailsAsync(
            this VirtualClientComponent component, IProcessProxy process, EventContext telemetryContext, string toolName = null, bool logToTelemetry = true, bool logToFile = true, int logToTelemetryMaxChars = 125000, string logFileName = null, bool timestamped = true, bool upload = true, bool telemetrySplit = false, params KeyValuePair<string, string>[] results)
        {
