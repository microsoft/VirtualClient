...
namespace VirtualClient
{
    ...
    /// </summary>
    public static class VirtualClientProcessLoggingExtensions
    {
        ...
        internal static void LogProcessDetails(this ILogger logger, ProcessDetails processDetails, string componentType, EventContext telemetryContext, int logToTelemetryMaxChars = 125000)
        {
            ...
            try
            {
                ...
                string eventNamePrefix = VirtualClientProcessLoggingExtensions.PathReservedCharacterExpression.Replace(
        ...
        internal static async Task LogProcessDetailsToFileAsync(this VirtualClientComponent component, ProcessDetails processDetails, EventContext telemetryContext)
        {
            ...
            try
            {
                ...
                {
                    string effectiveToolName = VirtualClientProcessLoggingExtensions.PathReservedCharacterExpression.Replace(
                    ...
                    string effectiveLogFileName = VirtualClientProcessLoggingExtensions.PathReservedCharacterExpression.Replace(
                    ...
                    await VirtualClientProcessLoggingExtensions.FileSystemAccessRetryPolicy.ExecuteAsync(async () =>
                    {
