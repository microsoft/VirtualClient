...
namespace VirtualClient
{
    ...
    public abstract partial class CommandBase
    {
        ...
        protected void ApplyAgentDefaults(PlatformSpecifics platformSpecifics)
        {
            ...
            this.LogToFile = true;
            this.Isolated = true;
            this.LogDirectory = platformSpecifics.GetAgentLocalLogsPath(this.ClientId, this.ExperimentId, this.ExperimentName);
            this.StateDirectory = platformSpecifics.GetAgentLocalStatePath(this.ExperimentId);
            this.TempDirectory = platformSpecifics.GetAgentLocalTempPath(this.ExperimentId);
            ...
            {
                this.PackageDirectory = AgentSpecifics.GetAgentLocalPackagesPath(platformSpecifics);
            }
        }
