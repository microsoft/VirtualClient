...
namespace VirtualClient.Agent
{
    ...
    public class ExecuteRemoteAgentCommandTests
    {
        ...
        [Test]
        [TestCase(
            "remote --profile=ANY-PROFILE.json --packages=https://anystore @./agents.rsp", 
            "--profile=ANY-PROFILE.json --packages=https://anystore")]
        [TestCase(
            "remote --command=./packages/scripts/execute_script.sh @./agents.rsp", 
            "--command=./packages/scripts/execute_script.sh")]
        public void SdkAgentRemoteCommandRemovesResponseFileReferences(string originalCommand, string expectedTargetCommand)
        {
        ...
        [TestCase(
            ...
            "--profile=ANY-PROFILE.json --packages=anystore --timeout=01:00:00")]
        [TestCase(
            "remote --profile=ANY-PROFILE.json --packages=anystore --timeout=01:00:00 --package-dir=/any/packages --target=user@10.1.2.3;pass --target=user@10.1.2.4;pass",
            "--profile=ANY-PROFILE.json --packages=anystore --timeout=01:00:00 --package-dir=/any/packages")]
        ...
        [TestCase(
            ...
            "--command=\"./packages/custom_scripts.1.0.0/execute_workload.py --log-dir=/any/log/dir\" --packages=anystore --timeout=01:00:00")]
        [TestCase(
            "remote -C \"./packages/custom_scripts.1.0.0/execute_workload.py --log-dir=/any/log/dir\" --packages=anystore --timeout=01:00:00 --package-dir=/any/packages --target=user@10.1.2.3;pass --target=user@10.1.2.4;pass",
            "-C \"./packages/custom_scripts.1.0.0/execute_workload.py --log-dir=/any/log/dir\" --packages=anystore --timeout=01:00:00 --package-dir=/any/packages")]
        ...
        public async Task SdkAgentRemoteCommandHandlesCommonPowerShellScenarios(string commandLine, string expectedCommand)
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                ...
                string[] preprocessedArgs = CommandFactory.SdkAgent.PreprocessArguments(args);
