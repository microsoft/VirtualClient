    ...
    public class OptionFactoryTests
    {
        ...
        public void ProxyApiOptionsCannotBeUsedAtTheSameTimeWithThePackageStoreOption()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                ...
                CommandLineBuilder commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--package-store=https://any.blob.store", "--proxy-api=http://anyuri" }, tokenSource);
                Assert.Throws<ArgumentException>(() => commandBuilder.Build().Parse("--package-store=https://any.blob.store --proxy-api=http://anyuri"));

                commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--proxy-api=http://anyuri", "--package-store=https://any.blob.store" }, tokenSource);
        ...
        public void PackageStoreOptionDoesNotApplyDefaultWhenProxyIsUsed()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                CommandLineBuilder commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--proxy-api=http://anyuri" }, tokenSource);
        ...
        public void ProxyApiOptionsCannotBeUsedAtTheSameTimeWithTheContentStoreOption()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                ...
                CommandLineBuilder commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--content-store=https://any.blob.store", "--proxy-api=http://anyuri" }, tokenSource);
                Assert.Throws<ArgumentException>(() => commandBuilder.Build().Parse("--content-store=https://any.blob.store --proxy-api=http://anyuri"));

                commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--proxy-api=http://anyuri", "--content-store=https://any.blob.store" }, tokenSource);
        ...
        public void ProxyApiOptionsCannotBeUsedAtTheSameTimeWithTheEventHubConnectionStringOption()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                ...
                CommandLineBuilder commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--event-hub=sb://any.servicebus.hub?miid=1234567", "--proxy-api=http://anyuri" }, tokenSource);
                ...
                commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--proxy-api=http://anyuri", "--event-hub=sb://any.servicebus.hub?miid=1234567" }, tokenSource);
        ...
        public void TimeoutOptionsCannotBeUsedAtTheSameTimeAsAProfileIterationsOptionAndViceVersa()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                CommandLineBuilder commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--profile=ANY.json", "--timeout=1440", "--iterations=3" }, tokenSource);
                ...
                commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--profile=ANY.json --iterations=3 --timeout=1440" }, tokenSource);
        ...
        public void TimeoutOptionsCannotBeUsedAtTheSameTimeAsTheDependenciesFlag()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                CommandLineBuilder commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--profile=ANY.json", "--timeout=1440", "--dependencies" }, tokenSource);
        ...
        public void IterationsOptionsCannotBeUsedAtTheSameTimeAsTheDependenciesFlag()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                CommandLineBuilder commandBuilder = CommandFactory.CreateCommandLine(new string[] { "--profile=ANY.json", "--iterations=3", "--dependencies" }, tokenSource);
        ...
        public void IterationsOptionsCanParsedCorrectlyWithPackagesSasurl()
        {
            using (CancellationTokenSource tokenSource = new CancellationTokenSource())
            {
                ...
                CommandLineBuilder commandBuilder = CommandFactory.CreateCommandLine(new string[] { }, tokenSource);
