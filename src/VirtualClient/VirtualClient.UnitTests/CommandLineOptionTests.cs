    ...
    internal partial class CommandLineOptionTests
    {
        ...
        public void VirtualClientThrowsWhenAnUnrecognizedOptionIsSuppliedOnTheCommandLine(string option, string value)
        {
            using (CancellationTokenSource cancellationSource = new CancellationTokenSource())
            {
                ...
                {
                    CommandLineBuilder commandBuilder = CommandFactory.CreateCommandBuilder(arguments.ToArray(), cancellationSource);
                    commandBuilder.ParseArguments(arguments.ToArray(), out IEnumerable<Token> commandLineTokens);
                });
