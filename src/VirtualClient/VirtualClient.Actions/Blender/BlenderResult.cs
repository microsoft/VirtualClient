...
namespace VirtualClient.Actions.Blender // Change this to your actual namespace
{
    /// <summary>
    /// The root object that holds all other entities in the structure.
    /// </summary>
    public class BlenderResult
    {
        /// <summary>
