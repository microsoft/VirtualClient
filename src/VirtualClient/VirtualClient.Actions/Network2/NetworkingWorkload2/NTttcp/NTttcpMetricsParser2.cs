...
namespace VirtualClient.Actions
{
    ...
    /// </summary>
    public class NTttcpMetricsParser2 : MetricsParser
    {
        ...
        public NTttcpMetricsParser2(string rawText, bool isClient)
            : base(rawText)
        {
        ...
        /// do not use outside the context of <see cref="NTttcpMetricsParser2"/>
        /// </summary>
