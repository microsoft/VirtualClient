...
namespace VirtualClient.Actions
{
    ...
    /// <summary>
    /// Parser for Metaseq output document
    /// </summary>
    public class MetaseqMetricsParser : MetricsParser
    {
        ...
        /// <summary>
        /// Constructor for <see cref="MetaseqMetricsParser"/>
        /// </summary>
        /// <param name="rawText">Raw text to parse.</param>
        /// <param name="accuracyMode">Mode for which output file needs to be parsed.</param>
        public MetaseqMetricsParser(string rawText, bool accuracyMode)
            : base(rawText)
        {
