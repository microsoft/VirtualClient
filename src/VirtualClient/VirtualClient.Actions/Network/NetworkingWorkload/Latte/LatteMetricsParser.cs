...
namespace VirtualClient.Actions.NetworkPerformance
{
    ...
    public class LatteMetricsParser : MetricsParser
    {
        ...
        private IEnumerable<HistogramEntry> GetLatencyHistogramData()
        {
            ...
            {
                Match histogramEntry = LatteMetricsParser.HistogramEntryExpression.Match(line);
