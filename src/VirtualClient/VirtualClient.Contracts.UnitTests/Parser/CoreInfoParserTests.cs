...
namespace VirtualClient.Contracts
{
    ...
    internal class CoreInfoParserTests
    {
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(CoreInfoParserTests), "test_examples", "CoreInfo", "CoreInfo_Results_Intel.txt"));
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(CoreInfoParserTests), "test_examples", "CoreInfo", "CoreInfo_Results_Intel_2.txt"));
            CoreInfoParser parser = new CoreInfoParser(results);
            CpuInfo info = parser.Parse();
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(CoreInfoParserTests), "test_examples", "CoreInfo", "CoreInfo_Results_Intel_3.txt"));
            CoreInfoParser parser = new CoreInfoParser(results);
            CpuInfo info = parser.Parse();
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(CoreInfoParserTests), "test_examples", "CoreInfo", "CoreInfo_Results_AMD.txt"));
            CoreInfoParser parser = new CoreInfoParser(results);
            CpuInfo info = parser.Parse();
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(CoreInfoParserTests), "test_examples", "CoreInfo", "CoreInfo_Results_AMD_Milan.txt"));
            CoreInfoParser parser = new CoreInfoParser(results);
            CpuInfo info = parser.Parse();
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(CoreInfoParserTests), "test_examples", "CoreInfo", "CoreInfo_Results_Ampere.txt"));
            CoreInfoParser parser = new CoreInfoParser(results);
            CpuInfo info = parser.Parse();
        ...
        {
            string results = File.ReadAllText(MockFixture.GetDirectory(typeof(CoreInfoParserTests), "test_examples", "CoreInfo", "CoreInfo_Results_Ampere_2.txt"));
            CoreInfoParser parser = new CoreInfoParser(results);
            CpuInfo info = parser.Parse();
