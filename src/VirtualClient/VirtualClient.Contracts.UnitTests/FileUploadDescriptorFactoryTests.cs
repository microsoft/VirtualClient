...
namespace VirtualClient.Contracts
{
    ...
    public class FileUploadDescriptorFactoryTests
    {
        ...
        [TestCase("Agent01", "ToolA", "Scenario01", null)]
        [TestCase("Agent01", "ToolA", "Scenario01", "Client")]
        public void FileUploadDescriptorFactoryCreatesTheExpectedDescriptor_When_Not_Timestamped_With_VirtualDirectory(string expectedAgentId, string expectedToolName, string expectedScenario, string expectedRole)
        {
            this.SetupDefaults();
            ...
            // The blob path itself is lower-cased. However, the file name casing is NOT modified.
            expectedBlobPath = !string.IsNullOrWhiteSpace(expectedBlobPath)
                ? $"/{expectedBlobPath}/local/system/{expectedFileName}"
                : $"/local/system/{expectedFileName}";
            ...
            string pathTemplate = "{experimentId}/{agentId}/{toolName}/{role}/{scenario}";
            FileUploadDescriptor descriptor = FileUploadDescriptorFactory.CreateDescriptor(context, timestamped: false, pathTemplate: pathTemplate, virtualDirectory: "/local/system");
        ...
        [TestCase("Agent01", "ToolA", "Scenario01", null)]
        [TestCase("Agent01", "ToolA", "Scenario01", "Client")]
        public void FileUploadDescriptorFactoryCreatesTheExpectedDescriptor_When_Timestamped_With_VirtualDirectory(string expectedAgentId, string expectedToolName, string expectedScenario, string expectedRole)
        {
            this.SetupDefaults();
            ...
            string pathTemplate = "{experimentId}/{agentId}/{toolName}/{role}/{scenario}";
            FileUploadDescriptor descriptor = FileUploadDescriptorFactory.CreateDescriptor(context, timestamped: true, pathTemplate: pathTemplate, virtualDirectory: "local\\system\\");
        ...
        [Test]
        public void FileUploadDescriptorFactoryCreatesTheExpectedDescriptorWithDefaultContentPathTemplate_Scenario_3()
        {
            //  Default Template:
            //  {experimentId}/{agentId}/{toolName}/{scenario}
            this.SetupDefaults();
            ...
            // The blob path itself is lower-cased. However, the file name casing is NOT modified.
            expectedBlobPath = $"/{expectedBlobPath}/local/system/{expectedFileName}";
            ...
            FileUploadDescriptor descriptor = FileUploadDescriptorFactory.CreateDescriptor(context, timestamped: true, virtualDirectory: "local/system");
        ...
        [Test]
        public void FileUploadDescriptorFactoryCreatesTheExpectedDescriptorWithDefaultContentPathTemplate_Scenario_4()
        {
            //  Default Template:
            //  {experimentId}/{agentId}/{toolName}/{role}/{scenario}
            this.SetupDefaults();
        ...
        public void FileUploadDescriptorFactoryCreatesTheExpectedDescriptorWithCustomContentPathTemplates_WithVirtualDirectory(string contentPathTemplate, string expectedContainer, string expectedBlobPath)
        {
            this.SetupDefaults();
            ...
            // The blob path itself is lower-cased. However, the file name casing is NOT modified.
            expectedBlobPath = $"{expectedBlobPath.ToLowerInvariant().TrimEnd('/')}/local/system/{expectedFileName}";
            ...
            FileUploadDescriptor descriptor = FileUploadDescriptorFactory.CreateDescriptor(context, metadata: componentMetadata, timestamped: true, pathTemplate: contentPathTemplate, virtualDirectory: "/local/system/");
        ...
        public void FileUploadDescriptorFactoryCreatesTheExpectedDescriptorWithCustomContentPathTemplatesDefinedInCommandLineMetadata_WithVirtualDirectory(string contentPathTemplate, string expectedContainer, string expectedBlobPath)
        {
            this.SetupDefaults();
            ...
            FileUploadDescriptor descriptor = FileUploadDescriptorFactory.CreateDescriptor(context, metadata: componentMetadata, timestamped: true, virtualDirectory: "local/system/");
        ...
        [TestCase("ContentPathTemplate")]
        [TestCase("contentPathTemplate")]
        public void FileUploadDescriptorFactoryIsNotCaseSensitiveOnContentPathTemplatesDefinedInCommandLineMetadata_WithVirtualDirectory(string contentPathTemplateParameterName)
        {
            this.SetupDefaults();
            ...
            // The blob path itself is lower-cased. However, the file name casing is NOT modified.
            string expectedContainer = "customcontainer";
            string expectedBlobPath = $"/645f6639-98c6-41ee-a853-b0a3ab8ce0a3/test_experiment/cfad01a9-8f5c-4210-841e-63210ed6a85d,revision01/642,042728166da7,37,192.168.2.155/cycle-vegaserver/client/local/system/{expectedFileName}";
        ...
        public void FileUploadDescriptorFactoryCreatesTheExpectedDescriptorWithCustomContentPathTemplatesDefinedInComponentParameters_WithVirtualDirectory(string contentPathTemplate, string expectedContainer, string expectedBlobPath)
        {
            this.SetupDefaults();
            ...
            FileUploadDescriptor descriptor = FileUploadDescriptorFactory.CreateDescriptor(context, parameters: componentParameters, timestamped: true, virtualDirectory: "local\\system");
        ...
        public void FileUploadDescriptorFactoryCreatesBlobPathsWithTheExpectedCasing_WithVirtualDirectory(string contentPathTemplate, string expectedContainer, string expectedBlobPath)
        {
            this.SetupDefaults();
            ...
            FileUploadDescriptor descriptor = FileUploadDescriptorFactory.CreateDescriptor(context, timestamped: true, pathTemplate: contentPathTemplate, virtualDirectory: "local/system");
        ...
        [Test]
        [TestCase("/local/system/", "local/system")]
        [TestCase("/local/system", "local/system")]
        [TestCase("local/system/", "local/system")]
        [TestCase("local/system", "local/system")]
        [TestCase("\\local\\system\\", "local/system")]
