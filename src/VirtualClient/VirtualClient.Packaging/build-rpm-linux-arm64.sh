...
BUILD_DIR="$REPO_ROOT/out/bin/Debug/ARM64/VirtualClient.Main/net8.0/linux-arm64/publish/"
...
rpmbuild --target aarch64 --define "_topdir $RPM_DIR" -ba "$RPM_DIR/SPECS/$PACKAGE_NAME.spec"

# out/packages/rpm_arm64/RPMS/aarch64/virtualclient-1.0.0-1.aarch64.rpm
echo "RPM package created: $RPM_DIR/RPMS/aarch64/$PACKAGE_NAME-$PACKAGE_VERSION-1.aarch64.rpm"
